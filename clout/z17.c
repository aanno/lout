...
{ int res;  float num; 
  ...
  else switch( *str )
  {
    ...
    case CH_UNIT_SP:
      ...
      res = num * width(space_gap_ref(style));
      break;

    case CH_UNIT_VS:
      
      res = num * width(line_gap_ref(style));
      break;
...
{ int w;  float num; 
  ...
  *res_inc = GAP_ABS;
  ...
  switch( *str++ )
  {
    ...
    case CH_UNIT_SP:	setwidths( num*width(space_gap_ref(style)),  FIXED_UNIT );
    case CH_UNIT_VS:	setwidths( num*width(line_gap_ref(style)),   FIXED_UNIT );
